...
<div class="container-fluid overflow-hidden">
    <div class="row">
        <div class="col-lg-12 text-center">
            <div class="card">
                <div class="card-header top_margin">
                    <div class="row">
                ...
                <div class="card-body">
                    <div class="img_panel d-flex justify-content-center position-relative">
                        ...
                        <div class="single_img_div">
                            ...
                            <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_one) }}" download="{{ $tender->subCategory->sub_category_name }}_image1.jpg">Download</a>
                        ...
                        <div class="single_img_div">
                            ...
                            <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_two) }}" download="{{ $tender->subCategory->sub_category_name }}_image2.jpg">Download</a>
                        ...
                        <div class="single_img_div">
                            ...
                            <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_three) }}" download="{{ $tender->subCategory->sub_category_name }}_image3.jpg">Download</a>
                        ...
                        <div class="single_img_div">
                            ...
                            <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_four) }}" download="{{ $tender->subCategory->sub_category_name }}_image4.jpg">Download</a>
                        ...
                        <div class="single_img_div">
                            ...
                            <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_five) }}" download="{{ $tender->subCategory->sub_category_name }}_image5.jpg">Download</a>
                    ...
                    <div class="next-prev-btn-div">
                        <button class="btn btn-primary prev-btn" onclick="plusDivs(-1)">❮ Prev</button>
                        <button class="btn btn-primary next-btn" onclick="plusDivs(1)">Next ❯</button>
                    </div>
                </div>
