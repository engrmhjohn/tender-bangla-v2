...
<div class="container-fluid pc_margin" style="overflow: hidden;">
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-center">
                    ...
                    <div class="single_img_div">
                        ...
                        <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_two) }}" download="{{ $tender->tender_title }}_image2.jpg">Download</a>
                    ...
                    <div class="single_img_div">
                        ...
                        <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_three) }}" download="{{ $tender->tender_title }}_image3.jpg">Download</a>
                    ...
                    <div class="single_img_div">
                        ...
                        <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_four) }}" download="{{ $tender->tender_title }}_image4.jpg">Download</a>
                    ...
                    <div class="single_img_div">
                        ...
                        <a class="btn btn-sm btn-warning download_btn" href="{{ asset($tender->tender_image_five) }}" download="{{ $tender->tender_title }}_image5.jpg">Download</a>
    ...
    <div class="slider_buttons bg-white">
        <div class="next-prev-btn-div">
            <button class="btn btn-danger prev-btn" onclick="plusDivs(-1)">❮ Prev</button>
            <button class="btn btn-danger next-btn" onclick="plusDivs(1)">Next ❯</button>
        </div>
