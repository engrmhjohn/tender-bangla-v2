...
<head>
    ...
    <title>Admin Forgot Password :: Dental Door BD</title>
    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <div class="contact-form">
                ...
                <p class="message">Forgot your password? No problem. Just let us know your email address
                ...
                <div class="" style="margin-top: 30px;">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <button type="submit" class="btn btn-primary form-control">Email Password
                            Reset Link</button>
                    </form>
                </div>
            </div>
