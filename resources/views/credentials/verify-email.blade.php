...
<head>
    ...
    <title>Admin Login :: Dental Door BD</title>
    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <div class="contact-form">
                ...
                <p class="message">Before continuing, could you verify your email address by clicking on
                ...
                <a href="{{ route('profile.show') }}" style="padding: 0px 40px; color: whitesmoke;">Edit Profile</a>
                <div>
                    <form method="POST" action="{{ route('logout') }}" class="inline" style="margin-top: 20px;">
                        @csrf

                        <button type="submit" class="btn" style="background: red; color: whitesmoke;">
                            Log Out
                        </button>
                    </form>
                </div>
