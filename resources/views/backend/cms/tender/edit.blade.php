                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="tender_validity" type="date" value="{{ isset($tender->tender_validity) ? $tender->tender_validity : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="tender_type" id="paid" class="with-gap" {{ isset($tender->tender_type) && $tender->tender_type == 1 ? 'checked' : '' }} checked value="1" required>
                                    <label for="paid">Paid</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="tender_type" id="free" class="with-gap" {{ isset($tender->tender_type) && $tender->tender_type == 0 ? 'checked' : '' }} value="0" required>
